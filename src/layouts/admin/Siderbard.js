...
function Siderbard() {
    return (
        ...
        <div className="sb-sidenav-menu">
            ...
            <Link className="nav-link" to="/categorysliste">
                <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt" /></div>
                Catégorys liste
            </Link>
            ...
            <Link className="nav-link" to="/productsliste">
                <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt" /></div>
                Product liste
            </Link>
            <div className="sb-sidenav-menu-heading">Catégorys</div>
            <Link className="nav-link collapsed" to="/categorys" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
