...
import ListeProduct from './component/admin/product/ListeProduct';
...
function App() {
    return ( <
        ...
        exact component = { EditCategory }
        /> <
        Route path = "/categorysliste"
        exact component = { CategoryListe }
        /> <
        ...
        component = { Product }
        /> <
        Route exact path = "/productsliste"
        component = { ListeProduct }
        />
